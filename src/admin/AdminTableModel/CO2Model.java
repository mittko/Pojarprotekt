...
public class CO2Model extends DefaultTableModel {
	...
	private static final Object[] partsObject = {
	    ...
	    MainPanel.BoyaKolichka,MainPanel.BoyaPojarogasitel,MainPanel.Etiket,MainPanel.SadZaGasitelnoVeshtestvo,MainPanel.GasitelnoVeshtestvoCO2
	};
	...
	static void testInit() {
	 ...
	 // because there is wrong (swapped) populated data in db table
		...
		for(int i = 0;i < partsObject.length;i++) {
			for(int j = 0;j < var;j++) {
				PriceTable.initPartPriceTable(partsObject[i].toString(),MainPanel.type_CO2, 
