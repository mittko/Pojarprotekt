...
class AddNewExtinguisherDialog extends MainPanel {
	...
	private ClientsListComboBox2 kontragentsComboBox;
	...
	private JLabel deliveryValueLabel;
	private JButton bestValueButton;
	...
	public AddNewExtinguisherDialog(String kontragent, String prevValue,
		...
		bestValueButton = new JButton("Пред. цена");
		...
		deliveryValueLabel = new JLabel("Доставна цена");
		// deliveryValueButton.addActionListener(new ActionListener() {
		//
		// @Override
		// public void actionPerformed(ActionEvent e) {
		// // TODO Auto-generated method stub
		// String artikul = typeCombo.getSelectedItem().toString()
		// + " ( Нов ) "
		// + wheightCombo.getSelectedItem().toString();
		// GetDeliveryValueForArtikul getDeliveryPrice = new
		// GetDeliveryValueForArtikul(
		// artikul);
