...
public class AddArtikulDialog extends MainPanel {
	...
	public AddArtikulDialog(final String artikulItem, String skladitem,
...
//			public void actionPerformed(ActionEvent e) {
//				// TODO Auto-generated method stub
//				String artikul = artikulsComboBox.getSelectedItem().toString();
//				/*
//				 * String kontragent =
//				 * clientComboBox.getSelectedItem().toString(); String
//				 * invoiceByKontragent = invoiceField.getText();
...
//		});
		...
		currValueField.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ke) {
				JTextField textField = (JTextField) ke.getSource();
				AddArtikulDialog.this.oldValueItem = textField.getText();
				// System.out.printf("%s\n",
...
//				bigFinalValueField.setText(finalValue + "");
		...
		rightPanel.add(loadButton, gbc08);
