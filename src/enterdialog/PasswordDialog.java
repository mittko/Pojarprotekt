	...
	private void loadSallerDataAndDoingPrice() {
		SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
			...
			protected Void doInBackground() throws Exception {
				...
				WorkingBook.TO_PRICE = WorkPriceDB.getWorkValue(MainPanel.“Œ);

				WorkingBook.HI_PRICE = WorkPriceDB.getWorkValue(’»);
...
//	  Worker.TO_PRICE =
//	  WorkPriceDB.getWorkValue(“Œ);
//
//	  Worker.HI_PRICE = WorkPriceDB.getWorkValue(’»);
//
//	  return null; }
//
//	  }; sw.execute(); }
