package ExportToExcell.Diary;

import Exceptions.InOutException;
import ExportToExcell.Diary.Workers.GetClientInfoWorker;
import ExportToExcell.Diary.Workers.GetDiaryInfoWorker;
import ExportToExcell.Diary.Workers.GetInvoiceNumberFromProtokolWorker;
import jxl.Workbook;
...
public class ExportDiaryIntoExcell {
	private WritableCellFormat font10 = getExcellCellFormat(WritableFont.ARIAL,
			10, Colour.BLACK);
	...
	private WritableImage getImage(int row, int column, byte[] bytes) {
		WritableImage image = new WritableImage(column, row, 1, 1, bytes);
