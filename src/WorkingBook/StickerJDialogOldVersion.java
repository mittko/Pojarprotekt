...
public class StickerJDialogOldVersion extends MainPanel {
    ...
    public StickerJDialogOldVersion(final JDialog parentDialog, final boolean isTO, final boolean isP, final boolean isHI, final String barcod) {
        ...
        if (isTO) {
            ...
            (this.TO_Button = new StickerButton(isTO, parentDialog, barcod, MainPanel.“Œ)).setActionCommand("button1");
        ...
        if (isHI) {
            ...
            (this.HI_Button = new StickerButton(isHI, parentDialog, barcod, MainPanel.’»)).setPreferredSize(new Dimension(300, 200));
