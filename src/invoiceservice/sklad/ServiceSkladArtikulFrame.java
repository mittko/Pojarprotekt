...
public class ServiceSkladArtikulFrame extends MainPanel {
	...
	public ServiceSkladArtikulFrame(final DefaultTableModel invoiceTableModel
	/*
...
//						invoiceByKontragent });  OLD LOGIC THAT WORK !!!
	...
	private void goodbyeCruelWorld() {
		JDialog jd = (JDialog) SwingUtilities
				.getWindowAncestor(ServiceSkladArtikulFrame.this);
		jd.dispose();
	}
