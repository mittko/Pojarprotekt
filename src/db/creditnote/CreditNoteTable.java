...
public class CreditNoteTable {
    ...
    private void createCreditNoteTable() {
        String command = "create table CreditNoteTable (id varchar(20), payment varchar(100)," +
                ...
                "invoiceByKontragent varchar(20) ) ";
    ...
    public static int insertCreditNote(String id,String  payment, String discount ,
        ...
        String command = "insert into CreditNoteTable values ('" + id + "','" + payment + "','" + discount
    ...
    public static ArrayList<ArrayList<Object>> getCreditNotes() throws SQLException {
        String command = "select * from CreditNoteTable";
        Connection connection = null;
        Statement statement = null;
        ResultSet resultSet;
