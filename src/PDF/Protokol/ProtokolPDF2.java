...
//
//public class ProtokolPDF2 extends PdfCreator {
//
...
//		ProtokolPDF2 pdf = new ProtokolPDF2();
...
//		n.setNoWrap(true);
//		PdfPCell mark = new PdfPCell(new Phrase("Идентификационна маркировка\n"
...
//
//		try {
//			dynamicTable.setWidths(new float[] { 3.5f, 18f, 4.3f, 5f, 6.5f, 7f,
//					5.5f, 5.5f, 5f, 4.3f, 5f });
...
//				PdfPCell cell7 = new PdfPCell(new Phrase("воден", font8));
...
//				PdfPCell cell9 = new PdfPCell(new Phrase("CO2", font8));
...
//			String hidrostatichno_izpitvane = dm
...
//				// / изпитване е направено сега
//				// String izminaliDniOtHI = GetDate.getUrgentDays(
...
//
//			if (type.equals(MainPanel.type_Prah_BC)
//					&& (!tehnichesko_obslujvane.equals("") && !prezarejdane
//							.equals(""))) {
//				nomerRazreshitelno = "Кобра ABC";
//			} else if (type.equals(MainPanel.type_Prah_ABC)
//					&& (!tehnichesko_obslujvane.equals("") && !prezarejdane
//							.equals(""))) {
//				nomerRazreshitelno = "Кобра ABC";
//			} else if (type.equals(MainPanel.type_Water)
//					&& (!tehnichesko_obslujvane.equals("") && !prezarejdane
//							.equals(""))) {
//				nomerRazreshitelno = "Вода";
//			} else if (type.equals(MainPanel.type_Water_Fame)
//					&& (!tehnichesko_obslujvane.equals("") && !prezarejdane
//							.equals(""))) {
//				nomerRazreshitelno = "STHAMEX";
//			} else if (type.equals(MainPanel.type_CO2)
//					&& (!tehnichesko_obslujvane.equals("") && !prezarejdane
//							.equals(""))) {
...
//					new Phrase(nomerRazreshitelno, font8));
...
//						dynamicTable.addCell(cellName); // column 9 име на лицето извършило обслужване
//
...
//			y = document.top();
//		}
//		setText("" + clData[4] + " ", footX[16], y - footY[16], "italic", 9);
//
