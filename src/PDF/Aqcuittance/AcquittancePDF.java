...
//							"\\Стокова Разписка-" + timeStamp + "-" + acquittanceNumber + ".pdf"));
//			
...
//		
//		
//		setText("СТОКОВА РАЗПИСКА \u2116 " + acquittanceNumber,titleX,titleY,"arialbd",12);
//		
//	
//
//		// set up table
...
//		Phrase sallerPhrase = new Phrase("Доставчик : " + MainPanel.SALLER_NAME ,arial10);
//		sallerInfo2Cell.addElement(sallerPhrase);
//		Phrase cityPhrase = new Phrase("Град : " + MainPanel.SALLER_CITY,arial10);
//		sallerInfo2Cell.addElement(cityPhrase);
//		Phrase addressPhrase = new Phrase("Адрес: " + MainPanel.SALLER_ADDRESS,arial10);
...
//		Phrase ddsPhrase = new Phrase("ДДС \u2116 BG" + MainPanel.SALLER_EIK,arial10);
...
//		Phrase bankPhrase = new Phrase("Банка: " + MainPanel.SALLER_BANK,arial10);
...
//		Phrase namePhrase = new Phrase("Получател:  " + (!name.equals("-") ? name : ""),arial10);
//		clientInfo2Cell.addElement(namePhrase);
//		Phrase cityPhrase2 = new Phrase("Град: " + (!city.equals("-") ? city : ""),arial10);
//		clientInfo2Cell.addElement(cityPhrase2);
//		Phrase addressPhrase2 = new Phrase("Адрес: " + (!address.equals("-") ? address : ""),arial10);
//		clientInfo2Cell.addElement(addressPhrase2);
//		Phrase eikPhrase2 = new Phrase("ЕИК: " + (!EIK.equals("-") ? EIK : ""),arial10);
//		clientInfo2Cell.addElement(eikPhrase2);
//		Phrase ddsPhrase2 = new Phrase("ДДС \u2116 BG" +(!EIK.equals("-") ? EIK : "") ,arial10);
//		clientInfo2Cell.addElement(ddsPhrase2);
//		Phrase molPhrase2 = new Phrase("Мол: " +(!MOL.equals("-") ? MOL : ""),arial10);
//		clientInfo2Cell.addElement(molPhrase2);
//		Phrase bankPhrase2 = new Phrase("Банка: " + (!BANK.equals("-") ? BANK : ""),arial10);
...
//	      finalSum *= ДДС;
//	      
//	      setText("Общо : " + String.format("%.2f",MyMath.round(finalSum, 2)),finalSumX,finalSumY,"arialbd",10);
//	      
//	}
