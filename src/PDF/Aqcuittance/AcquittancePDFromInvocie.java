...
public class AcquittancePDFromInvocie extends PdfCreator {
	...
	public void createAcquittancePDF2(ArrayList<String> clientInfo2,
		...
		setText("СТОКОВА РАЗПИСКА \u2116 " + acquittanceNumber, titleX, titleY,
				"arialbd", 12);
		...
		// repeat same table
		setText("СТОКОВА РАЗПИСКА \u2116 " + acquittanceNumber, titleX,
				y2 - 10, "arialbd", 12);
