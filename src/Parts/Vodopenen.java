...
public class Vodopenen extends MainPanel {

	public ArrayList<PartButton> list = null;
	public static PartButton plomba = null;
	public static PartButton woda_pqna = null;
	...
	public Vodopenen(Dimension dim) {
		int buttonVGap = 5;
		int buttonHGap = 20;
		list = new ArrayList<>();
		...
		paneList.add(pane4);
		paneList.add(pane5);
		//	if we want to add more arts, create one more pane add parts to it and add paneList to block
	...
	//	plomba.isEditable = false;
		...
		woda_pqna = new PartButton();
		woda_pqna.setPreferredSize(buttonDimension);
		woda_pqna.setAutoSizedIcon(woda_pqna, new LoadIcon().setIcons("PARTS2/woda.png"));
		woda_pqna.setToolTipText(getHTML_Text(GasitelnoVeshtestvoVodaPyana));
		woda_pqna.setName(GasitelnoVeshtestvoVodaPyana);
		woda_pqna.isEditable = false;
	...
	public static void main(String[] args) {
		...
		//  Framer f = new Framer(new Vodopenen());
	}
