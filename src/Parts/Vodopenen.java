...
public class Vodopenen extends MainPanel {
	...
	public static CustomButton вода_пяна = null;
...
//		етикет.setIcon(new LoadIcon().setIcons("PARTS/waterEtiket.png"));
	...
	//	съд.setIcon(new LoadIcon().setIcons("PARTS/съд.gif"));
		...
		вода_пяна = new CustomButton();
		вода_пяна.setPreferredSize(buttonDimension);
		вода_пяна.setAutoSizedIcon(вода_пяна, new LoadIcon().setIcons("PARTS2/вода.png"));
	//	вода_пяна.setIcon(new LoadIcon().setIcons("PARTS2/вода.png"));//вода+пяна.gif"));
		вода_пяна.setToolTipText(getHTML_Text(GasitelnoVeshtestvoVodaPyana));
		вода_пяна.setName(GasitelnoVeshtestvoVodaPyana);
		вода_пяна.isEditable = false;
